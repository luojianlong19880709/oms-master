...
class HostList_yz1(models.Model):
    ...
    monitor = models.CharField(max_length=10, verbose_name=u'是否添加监控')    
...
class HostList_yz2(models.Model):
    ip = models.CharField(max_length=20, verbose_name=u'IP地址')
    hostname = models.CharField(max_length=30, verbose_name=u'主机名')
    product = models.CharField(max_length=20, verbose_name=u'产品')
    application = models.CharField(max_length=40, verbose_name=u'应用')
...
class HostList_cer(models.Model):
    ip = models.CharField(max_length=20, verbose_name=u'IP地址')
    hostname = models.CharField(max_length=30, verbose_name=u'主机名')
    product = models.CharField(max_length=20, verbose_name=u'产品')
    application = models.CharField(max_length=40, verbose_name=u'应用')
